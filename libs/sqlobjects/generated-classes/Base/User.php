...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setIsStaff($v)
    {
        ...
        if ($this->is_staff !== $v) {
            $this->is_staff = $v;
            $this->modifiedColumns[UserTableMap::COL_IS_STAFF] = true;
        }
    ...
    public function setIsSuperuser($v)
    {
        ...
        if ($this->is_superuser !== $v) {
            $this->is_superuser = $v;
            $this->modifiedColumns[UserTableMap::COL_IS_SUPERUSER] = true;
        }
    ...
    public function setModifiedAt($v)
    {
        ...
        if ($this->modified_at !== null || $dt !== null) {
            if ($this->modified_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->modified_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserTableMap::COL_MODIFIED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UserTableMap::translateFieldName('ModifiedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_IS_STAFF)) {
            $modifiedColumns[':p' . $index++]  = 'is_staff';
        }
        if ($this->isColumnModified(UserTableMap::COL_IS_SUPERUSER)) {
            $modifiedColumns[':p' . $index++]  = 'is_superuser';
        }
        if ($this->isColumnModified(UserTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(UserTableMap::COL_MODIFIED_AT)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getIsStaff(),
            $keys[7] => $this->getIsSuperuser(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setIsStaff($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setIsSuperuser($arr[$keys[7]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_IS_STAFF)) {
            $criteria->add(UserTableMap::COL_IS_STAFF, $this->is_staff);
        }
        if ($this->isColumnModified(UserTableMap::COL_IS_SUPERUSER)) {
            $criteria->add(UserTableMap::COL_IS_SUPERUSER, $this->is_superuser);
        }
        if ($this->isColumnModified(UserTableMap::COL_CREATED_AT)) {
            $criteria->add(UserTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(UserTableMap::COL_MODIFIED_AT)) {
            $criteria->add(UserTableMap::COL_MODIFIED_AT, $this->modified_at);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIsStaff($this->getIsStaff());
