 ...
 * @method     ChildUserQuery orderByIsStaff($order = Criteria::ASC) Order by the is_staff column
 * @method     ChildUserQuery orderByIsSuperuser($order = Criteria::ASC) Order by the is_superuser column
 * @method     ChildUserQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     ChildUserQuery orderByModifiedAt($order = Criteria::ASC) Order by the modified_at column
 *
 ...
 * @method     ChildUserQuery groupByIsStaff() Group by the is_staff column
 * @method     ChildUserQuery groupByIsSuperuser() Group by the is_superuser column
 * @method     ChildUserQuery groupByCreatedAt() Group by the created_at column
 * @method     ChildUserQuery groupByModifiedAt() Group by the modified_at column
 *
...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'diy', $modelName = '\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, first_name, last_name, user_name, email, password, is_staff, is_superuser, created_at, modified_at FROM users WHERE id = :p0';
        try {
    ...
    /**
     * Filter the query on the is_staff column
     *
     * Example usage:
     * <code>
    ...
    public function filterByModifiedAt($modifiedAt = null, $comparison = null)
    {
        if (is_array($modifiedAt)) {
            ...
            if (isset($modifiedAt['min'])) {
                $this->addUsingAlias(UserTableMap::COL_MODIFIED_AT, $modifiedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($modifiedAt['max'])) {
                $this->addUsingAlias(UserTableMap::COL_MODIFIED_AT, $modifiedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_MODIFIED_AT, $modifiedAt, $comparison);
    }
